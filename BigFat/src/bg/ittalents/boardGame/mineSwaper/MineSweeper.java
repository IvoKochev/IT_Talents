...
public final class MineSweeper extends Game {
    ...
    private final String userSquare = Board.ANSI_GOLD + "\u0243" + Board.ANSI_BLACK;
    ...
    protected void makeGame() {
        this.getBoard().getMatrixx()[this.getRow()][this.getCol()] = "0";
    ...
    protected void play() {
        this.playerMove();
        this.makeGame();
        changeUserMatrix(this.getRow(), this.getCol(), false);
        int i = -1;
        boolean isFlag;
        ...
        while (i == -1) {
            ...
            int f = Game.input.nextInt();
            isFlag = (f == 0);
            i = changeUserMatrix(this.getRow(), this.getCol(), isFlag);
        }
        if (i == 0) {
            this.nextLevel();
        }
    ...
    private int changeUserMatrix(int row, int col, boolean isFlag) {
    ...
    protected void botMove() {
        try {
            throw new UnsupportedOperationException("Not supported yet game bot.");
